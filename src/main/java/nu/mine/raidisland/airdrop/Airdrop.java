...
public class Airdrop extends YamlConfig {
	...
	public int getChanceToExecuteCommand() {
		return chanceToExecuteCommand;
	}
	...
	public SimpleTime getOpeningDelayTime() {
		return openingDelayTime;
	}

	public List<SpawningEvent> getOnSpawnEvent() {
		return onSpawnEvent;
	}

	public boolean isAutoStartSpawn() {
		return autoStartSpawn;
	}

	public boolean isWorldGuardSetting() {
		return worldGuardSetting;
	}

	public String getRegionByWorldGuard() {
		return regionByWorldGuard;
	}
	...
	public int getRequirementConnectedPlayers() {
		return requirementConnectedPlayers;
	}
	...
	public static void addOpeningDelay(Airdrop airdrop , Chest chest) {
		//Common.runTimer(20 , new OpeningDelayTask(airdrop , chest))

		openingDelayTask.put(chest , new OpeningDelayTask(airdrop, chest).runTaskTimer(Core.getInstance() , 0 , 20));
	}
